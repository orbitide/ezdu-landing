    ...
    return (
        <>
            ...
            <ExamPageTemplate config={{
                ...
                features: [
                    { icon: '🃏', title: 'Flashcard', description: 'দেখো, মনে করো, উল্টাও — spaced repetition দিয়ে মনে রাখো।' },
                    { icon: '🧩', title: 'Word Quiz', description: 'MCQ quiz দিয়ে word মনে আছে কিনা যাচাই করো।' },
                    { icon: '📌', title: 'Context Sentences', description: 'প্রতিটি word কীভাবে ব্যবহার হয় তা sentence দিয়ে শেখো।' },
                    { icon: '🌍', title: 'IELTS Word List', description: 'IELTS Academic Word List (AWL) থেকে words শেখো।' },
                    { icon: '🏛️', title: 'BCS Vocabulary', description: 'BCS-এ বারবার আসা English words-এর আলাদা set।' },
                    { icon: '🔔', title: 'Daily Reminder', description: 'প্রতিদিন ১০টি নতুন word — notification দিয়ে মনে করিয়ে দেয়।' },
                ],
                faqs,
            }} />
        </>
