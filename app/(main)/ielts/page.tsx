    ...
    return (
        <>
            ...
            <ExamPageTemplate config={{
                ...
                stats: [
                    { label: 'Practice Questions', value: '৫,০০০+' },
                    { label: 'Mock Tests', value: '২০০+' },
                    { label: 'Vocabulary Sets', value: '১০০+' },
                    { label: 'সম্পূর্ণ বিনামূল্যে', value: '✓' },
                ],
                features: [
                    { icon: '📖', title: 'Reading Practice', description: 'Academic ও General reading passages দিয়ে প্র্যাকটিস।' },
                    { icon: '🎧', title: 'Listening Mock Test', description: 'IELTS-style listening questions দিয়ে mock test।' },
                    { icon: '📚', title: 'Vocabulary Builder', description: 'IELTS-এর জন্য দরকারি words flashcard দিয়ে শেখো।' },
                    { icon: '📊', title: 'Band Score Tracker', description: 'প্রতিটি test-এ estimated band score দেখো।' },
                    { icon: '🤖', title: 'AI Practice Sets', description: 'AI তোমার দুর্বল area থেকে প্রশ্ন বেছে দেয়।' },
                    { icon: '🔁', title: 'Daily Practice', description: 'প্রতিদিনের ছোট practice set — ধারাবাহিকতা বজায় রাখো।' },
                ],
                faqs,
            }} />
        </>
